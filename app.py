...
# --- HOME DASHBOARD (Only shows if no files uploaded and no chat history) ---
if not st.session_state.messages and not st.session_state.gemini_files:
    st.markdown("### 🎯 Choose Your Perfect Tutor")
    st.write("Select a persona from the sidebar based on what you need to study today:")
    
    col1, col2, col3 = st.columns(3)
    
    with col1:
        st.info("**🏃 Sprint Mode**\n\n*Best for: ADHD & Quick Reviews*\n\nFast-paced, dopamine-driven milestones. Generates visual flowcharts and quick active-recall challenges.")
        st.warning("**🎧 Commuter Podcast**\n\n*Best for: On-the-Go Learning*\n\nInteract via voice! Converts complex documents into engaging, conversational audio scripts.")
        
    with col2:
        st.success("**🔬 Deep Study**\n\n*Best for: STEM & Research*\n\nHardcore technical breakdowns. Extracts LaTeX math, analyzes data trends, and generates Plotly graphs.")
        st.error("**👁️ Visual Deconstructor**\n\n*Best for: Spatial Reasoning*\n\nBreaks down complex visual charts, diagrams, and data flows step-by-step for visual learners.")
        
    with col3:
        st.info("**🌍 Global Scholar**\n\n*Best for: ESL Students*\n\nBridges language barriers by explaining high-level academic concepts using simple, cross-cultural analogies.")
        st.success("**📖 Critical Analyst**\n\n*Best for: Humanities & Bio*\n\nActs as a Socratic professor. Focuses on thematic breakdowns, textual evidence, and deep critical thinking.")
        
    st.markdown("<br><h4 style='text-align: center;'>👈 Upload your study materials in the sidebar to begin!</h4>", unsafe_allow_html=True)
